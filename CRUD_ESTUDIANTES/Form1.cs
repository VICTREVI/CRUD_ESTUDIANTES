...
namespace CRUD_ESTUDIANTES
{
    public partial class Form1 : Form
    {
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO Estudiante (Codigo,Nombres,Apellidos,Direccion) values(@Codigo,@Nombres,@Apellidos,@Direccion)";
        ...
        {
            Conexion.Conectar();
            string actualizar = "UPDATE Estudiante set Codigo=@Codigo, Nombres=@Nombres, Apellidos=@Apellidos, Direccion=@Direccion where Codigo=@Codigo";
            ...
            MessageBox.Show("Se ha modificado correctamente con éxito");
            dataGridView1.DataSource = llenar_grid();
        ...
        {
            Conexion.Conectar();
            string eliminar = "DELETE FROM Estudiante where Codigo=@Codigo";
            SqlCommand cmd3 = new SqlCommand(eliminar,Conexion.Conectar());
            cmd3.Parameters.AddWithValue("@Codigo", txtcodigo.Text);

            cmd3.ExecuteNonQuery();

            MessageBox.Show("Se ha eliminado correctamente con éxito");
            dataGridView1.DataSource = llenar_grid();
        }
